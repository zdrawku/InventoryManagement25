    ...
    public class DbInit
    {
        public static void Initialize(SchoolInventory context)
        {
            ...
            var equipment = new Equipment[]
            {
                ...
                new Equipment{Name="Lenovo ThinkPad", Type="Laptop", SerialNumber="LT11223", Condition="Good", Status="Available", Location="Room 103", PhotoUrl="https://example.com/photos/lenovo_thinkpad.jpg"},
                new Equipment{Name="BenQ Monitor", Type="Monitor", SerialNumber="BM44556", Condition="Excellent", Status="Available", Location="Room 204", PhotoUrl="https://example.com/photos/benq_monitor.jpg"},
                new Equipment{Name="Logitech Webcam", Type="Webcam", SerialNumber="LW77889", Condition="Fair", Status="UnderRepair", Location="Conference Room", PhotoUrl="https://example.com/photos/logitech_webcam.jpg"},
                new Equipment{Name="Samsung Tablet", Type="Tablet", SerialNumber="ST99001", Condition="Good", Status="Unavailable", Location="Reception", PhotoUrl="https://example.com/photos/samsung_tablet.jpg"}
