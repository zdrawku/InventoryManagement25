    ...
    public class DbInit
    {
        public static void Initialize(SchoolInventory context)
        {
            if (!context.Users.Any())
            {
                ...
                admin.PasswordHash = passwordHasher.HashPassword(admin, "Admin!234");
                ...
                technician.PasswordHash = passwordHasher.HashPassword(technician, "Tech!234");
                ...
                staff.PasswordHash = passwordHasher.HashPassword(staff, "Staff!234");

                context.Users.AddRange(admin, technician, staff);
                context.SaveChanges();
            }
