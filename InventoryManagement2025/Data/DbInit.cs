    ...
    public class DbInit
    {
        public static void Initialize(SchoolInventory context)
        {
            ...
            var equipment = new Equipment[]
            {
                ...
                new Equipment{Name="Lenovo ThinkPad", Type="Laptop", SerialNumber="LT11223", Condition=Condition.Good, Status=EquipmentStatus.Available, Location="Room 103", PhotoUrl="https://example.com/photos/lenovo_thinkpad.jpg", IsSensitive=false},
                ...
                new Equipment{Name="Samsung Tablet", Type="Tablet", SerialNumber="ST99001", Condition=Condition.Good, Status=EquipmentStatus.Unavailable, Location="Reception", PhotoUrl="https://example.com/photos/samsung_tablet.jpg", IsSensitive=true}
